...
namespace Interfaz_proyecto_integrador
{
    public partial class ConsultarClientesIntermediarios : Form
    {
        ...
        {
            conexion.Open();
            OracleCommand comando = new OracleCommand("seleccionarClienteAgencia", conexion);
